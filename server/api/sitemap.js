...
const STATIC_PAGES = [
  ...
  { loc: '/referanslar', changefreq: 'monthly', priority: '0.8' },
  ...
  { loc: '/hizmetler/web-tasarim', changefreq: 'monthly', priority: '0.8' },
  { loc: '/partnerler/flavora', changefreq: 'monthly', priority: '0.6' },
  { loc: '/partnerler/techvibe', changefreq: 'monthly', priority: '0.6' },
  { loc: '/partnerler/greenlife', changefreq: 'monthly', priority: '0.6' },
  { loc: '/partnerler/urbanstyle', changefreq: 'monthly', priority: '0.6' },
  { loc: '/partnerler/petpal', changefreq: 'monthly', priority: '0.6' },
  { loc: '/partnerler/fitzone', changefreq: 'monthly', priority: '0.6' },
