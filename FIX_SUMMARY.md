...
- KadexAI production AI kotası Upstash REST + atomik Lua minute/day/cost/idempotency modeline taşındı; servis yoksa fail-closed 503.
- Bundle secret testi üç sentetik canary zorunlu kılıyor ve root dist ile KadexAI static/HTML/RSC build çıktısını tarıyor.
...
- Regresyonlar 15 root + 10 KadexAI + 5 FastAPI teste çıkarıldı.
