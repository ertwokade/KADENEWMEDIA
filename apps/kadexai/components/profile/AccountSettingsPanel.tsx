  ...
  const importBrief = async (event: ChangeEvent<HTMLInputElement>) => {
    ...
    setBriefMessage(
      result.importedFields.length > 0
        ? `${result.importedFields.length} profil alanı brief içinden hazırlandı. Kaydettiğinizde KadexAI kullanmaya başlayacak.`
        : 'Brief metni hazırlandı. Kaydettiğinizde KadexAI tüm üretimlerde kullanacak.'
    )
  }
        ...
        <div className="overflow-hidden rounded-xl border border-amber-400/25 bg-gradient-to-br from-amber-400/10 via-zinc-950/80 to-zinc-950">
          ...
          <div className="space-y-3 p-4">
            ...
            <div className="rounded-lg border border-zinc-800 bg-zinc-950/70 p-3">
              <p className="text-[11px] font-semibold uppercase tracking-wide text-zinc-500">KadexAI şu anda biliyor</p>
