...
export default function ToolRequirementBanner() {
  ...
  if (loading) {
    return (
      <div className="kade-requirement-banner kade-requirement-banner--loading flex flex-shrink-0 items-center gap-2 border-b border-zinc-800 bg-zinc-950 px-4 py-2 text-xs text-zinc-500 lg:px-7">
  ...
  if (missing.length === 0) {
    return (
      <div className="kade-requirement-banner kade-requirement-banner--ready flex flex-shrink-0 items-center gap-2 border-b border-emerald-950 bg-emerald-950/20 px-4 py-2 text-xs text-emerald-300 lg:px-7">
