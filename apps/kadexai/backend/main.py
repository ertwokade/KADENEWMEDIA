"""KadexAI Platform — Unified Backend
...
async def lifespan(app: FastAPI):
    ...
    print("KadexAI Platform Backend starting...")
    yield
    print("KadexAI Platform Backend shutting down...")


app = FastAPI(
    title="KadexAI Platform Backend",
    version="1.0.0",
...
async def video_factory(req: VideoFactoryRequest):
    """Konu/senaryodan tam video üretir (vendored KadexAI Video Fabrikası motoru).
