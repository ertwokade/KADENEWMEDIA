...
Yalnız `security-hardening-kadexai` dalındaki ve ana dala alındıktan sonra en son doğrulanmış release desteklenir. Eski desktop/deployment paketleri güncel sayılmaz.
...
- Reverse proxy yalnız `/kadexai` yolunu Next server’a yollar; API’yi SPA fallback’e düşürmez.
