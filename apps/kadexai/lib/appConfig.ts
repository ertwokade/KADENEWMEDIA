export const APP_BASE_PATH = process.env.NEXT_PUBLIC_BASE_PATH ?? '/kadexai'
export const PUBLIC_APP_URL = process.env.NEXT_PUBLIC_APP_URL || 'https://kadenewmedia.com/kadexai'
