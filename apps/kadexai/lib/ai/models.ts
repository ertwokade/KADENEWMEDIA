...
export const MODEL_CONFIGS: Record<AIModel, ModelConfig> = {
  ...
  claude: {
    ...
    label: 'Claude Sonnet',
    shortLabel: 'Claude',
    description: 'Premium kalite; sağlayıcı bağlantısı gerekir',
    provider: 'anthropic',
    free: false,
    speed: 'balanced',
    speedLabel: 'Premium',
  ...
  gpt4o: {
    ...
    label: 'GPT-4o',
    shortLabel: 'GPT-4o',
    description: 'OpenAI’ın en güçlü modeli; sağlayıcı bağlantısı gerekir',
    provider: 'openai',
    free: false,
    speed: 'balanced',
    speedLabel: 'Premium',
  ...
  gemini: {
    ...
    description: 'Google premium Gemini; sağlayıcı bağlantısı gerekir',
    provider: 'google',
