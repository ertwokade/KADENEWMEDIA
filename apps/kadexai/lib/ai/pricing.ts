...
function overrides(): Partial<Record<string, ModelRate>> {
  ...
  try {
    ...
    console.warn('[kadexai/pricing] AI_MODEL_RATES_JSON ayrıştırılamadı; varsayılan tablo kullanılıyor.')
  }
 ...
 * - Kullanıcı kendi anahtarını (BYOK) kullanıyorsa maliyet KadexAI'ye ait
