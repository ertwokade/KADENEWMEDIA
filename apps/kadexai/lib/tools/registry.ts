...
export const TOOL_REGISTRY: ToolDefinition[] = [
  ...
  tool('production-calendar', 'Prodüksiyon Takvimi', 'operations', '/dashboard/operations?view=calendar', 'calendar-days', 'Prodüksiyon kartlarının çekim ve yayın tarihlerini ay görünümünde gösterir.', [], false),
  tool('client-delivery', 'Müşteri & Teslim', 'operations', '/dashboard/operations?view=clients', 'users', 'Müşteri kayıtları ve teslim takibi.', [], false),
