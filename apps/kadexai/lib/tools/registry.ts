...
export const TOOL_REGISTRY: ToolDefinition[] = [
  ...
  tool('production-calendar', 'Yayın Takvimi', 'operations', '/dashboard/operations?view=calendar', 'calendar-days', 'Çekim ve yayın tarihlerini ay görünümünde gösterir.', [], false),
