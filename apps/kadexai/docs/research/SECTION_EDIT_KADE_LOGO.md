...
- Giriş ekranındaki geçici ikon ve `KadexAI` yazısını kullanıcının sağladığı yatay KADE logosuyla değiştirmek.
...
- `/kadexai/login` masaüstü ve mobil görünüm kontrolü.
- `/kadexai/dashboard` uygulama kabuğunda sol menü kontrolü.
