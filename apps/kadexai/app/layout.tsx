...
/* Tema tercihi kadenewmedia.com ile ORTAKTIR: KadexAI aynı origin altında
   /kadexai yolunda çalıştığı için localStorage paylaşılır. Site tercihi `theme`
...
export const metadata: Metadata = {
  ...
  applicationName: 'KadexAI',
  title: {
    default: 'KadexAI | Kade New Media',
    template: '%s | KadexAI',
  },
  description: 'KadexAI; Kade New Media için AI içerik üretimi, sosyal medya analizi ve operasyon yönetimi araçlarını tek panelde toplar.',
  keywords: ['KadexAI', 'Kade New Media', 'AI içerik üretimi', 'sosyal medya analizi', 'YouTube SEO', 'Instagram analiz', 'TikTok analiz', 'AI ajans araçları'],
  manifest: withBasePath('/manifest.json'),
  alternates: {
    canonical: siteUrl,
  },
  openGraph: {
    title: 'KadexAI | Kade New Media',
