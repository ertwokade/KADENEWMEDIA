...
import { createQuoteRequest, listOwnQuoteRequests, QuoteValidationError, validateQuoteInput } from '@/lib/quotes/kadexaiQuotes'
...
export async function POST(request: NextRequest) {
  ...
  try {
    ...
    void recordAuditEvent({
      ...
      resourceType: 'kadexai_quote_request',
      resourceId: quote.id,
