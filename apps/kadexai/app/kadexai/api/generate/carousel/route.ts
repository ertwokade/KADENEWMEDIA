...
import { asNumber, asRecord, asRecordList, asText } from '@/lib/ai/outputValidation'
...
export async function POST(req: NextRequest) {
  ...
  try {
    ...
    const carousel = { baslik: asText(parsed.baslik, 300), slayts: slides, caption: asText(parsed.caption, 5_000), hashtags: normalizeHashtagList(parsed.hashtags, 30) }
