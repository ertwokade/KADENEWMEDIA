...
const INFRA_DEFS = [
  ...
  { id: 'TIKTOK_OFFICIAL', label: 'TikTok Research API', use: 'KadeSearch canlı TikTok araması ve gerçek izlenme ölçümleri (resmi)' },
  { id: 'TIKTOK_COOKIE', label: 'TikTok oturumu (yedek)', use: 'Resmi API yoksa TikTok trend ve materyal toplama' },
  { id: 'INSTAGRAM_OFFICIAL', label: 'Instagram Graph API', use: 'KadeSearch canlı Reels hashtag araması (resmi)' },
...
export default function SettingsPage() {
  ...
  const [serverEnvStatus, setServerEnvStatus] = useState<Record<string, boolean>>({
    ...
    TIKTOK_OFFICIAL: false,
    TIKTOK_COOKIE: false,
    INSTAGRAM_OFFICIAL: false,
