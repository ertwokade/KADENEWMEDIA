...
import KadexAIDemo from '@/components/demo/KadexAIDemo'
...
const CANONICAL = `${SITE}/kadexai-demo`
...
export default async function KadexAIDemoPage() {
  const content = await getContent(DEMO_CONTENT_KEY)
