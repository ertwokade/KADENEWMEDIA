...
export const DEMO_CONTENT_KEY = 'kadeai-demo'

export const DEMO_CONTENT_DEFAULTS: DemoPageContent = {
  eyebrow: 'KadeAI interaktif demo',
  ...
  ctas: [
    { label: 'KadeAI’yi Dene', href: '/kadeai/login' },
  ...
  faq: [
    {
      question: 'KadeAI nedir?',
      answer: 'KadeAI sosyal medya analizi, içerik üretimi, planlama ve yeni medya operasyon araçlarını tek panelde birleştiren Kade New Media ürünüdür.',
    },
    {
  ...
  seo: {
    title: 'KadeAI Demo | AI Sosyal Medya ve İçerik Platformu',
    description: 'KadeAI sosyal medya analizcisi, içerik üretimi ve yeni medya operasyon araçlarının kanıta dayalı interaktif demosunu deneyin.',
    ogTitle: 'KadeAI Demo | AI İçerik ve Sosyal Medya Platformu',
