# KadeAI — Üçüncü Taraf Yazılım Bildirimleri (NOTICE)

KadeAI, aşağıdaki açık kaynak bileşenleri içerir veya kullanır. Her bileşenin
...
> ⚠️ Bu tablo, `apps/kadeai/vendor/` altına kopyalanan (vendored) her bileşen
...
| Bileşen | Kaynak | Lisans | KadeAI'da kullanım | Ticari kullanım |
|---|---|---|---|---|
...
2. **GPL-3.0 bileşen** (ComfyUI): KadeAI koduna KOPYALANMAZ/gömülmez. Yalnızca
   ayrı çalışan bir servis olarak HTTP API üzerinden çağrılır. Bu sınır
   korunduğu sürece kapalı KadeAI kodu GPL'e tabi olmaz.
3. **Ticari-değil / araştırma lisanslı** bileşenler (Wav2Lip, SadTalker,
   Coqui XTTS, F5-TTS model ağırlıkları vb.) KadeAI'a EKLENMEZ. Bu tür
...
- [ ] Marka/isim referansları KadeAI olarak değiştirildi mi?
