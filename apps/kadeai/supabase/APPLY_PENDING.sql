-- KadeAI — production'a uygulanmayı bekleyen migration'lar
-- Güncellendi: 2026-08-27
-- Tamamı ADDITIVE: CREATE TABLE IF NOT EXISTS / ADD COLUMN IF NOT EXISTS.
-- Hiçbir DROP, DELETE, TRUNCATE veya veri değiştiren ifade YOKTUR.
...
CREATE TABLE IF NOT EXISTS public.ai_usage_events (
  ...
  -- Kullanıcı kendi sağlayıcı anahtarını kullandıysa maliyet KadeAI'ye ait değildir.
...
-- ═══════════════════════════════════════════════════════════
-- 202608260007_kadeai_quote_requests.sql
-- ═══════════════════════════════════════════════════════════
...
-- ═══════════════════════════════════════════════════════════
-- 202608260008_kadeai_content_blocks.sql
-- ═══════════════════════════════════════════════════════════
...
--
-- Fiyat zaten kadeai_pricing_overrides üzerinden DB-driven'dı; ad ve özellik
...
ALTER TABLE public.kadeai_pricing_overrides
...
-- ═══════════════════════════════════════════════════════════
-- KadeAI İçerik Stüdyosu: kişisel marka sesi ve kaynak bağlı içerik paketleri.
