-- KADE AI account, workspace, brand and auditable tool-run data model.
...
DROP TRIGGER IF EXISTS on_auth_user_created_kadeai ON auth.users;
CREATE TRIGGER on_auth_user_created_kadeai
  AFTER INSERT ON auth.users
  FOR EACH ROW EXECUTE FUNCTION public.handle_kadeai_new_user();
