-- KadeAI SaaS fiyatlandırmasını (TIER_MONTHLY_TRY, PERIOD_FACTOR, API_EXCLUDED_DISCOUNT)
...
CREATE TABLE IF NOT EXISTS public.kadeai_pricing_overrides (
...
INSERT INTO public.kadeai_pricing_overrides (id)
VALUES (1)
ON CONFLICT (id) DO NOTHING;

ALTER TABLE public.kadeai_pricing_overrides ENABLE ROW LEVEL SECURITY;
ALTER TABLE public.kadeai_pricing_overrides FORCE ROW LEVEL SECURITY;
...
REVOKE ALL ON public.kadeai_pricing_overrides FROM anon, authenticated;
