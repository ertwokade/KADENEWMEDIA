...
-- Aynı Supabase projesi paylaşılıyor (KadeAI'nin auth.users / payment_orders / entitlements
...
CREATE TABLE IF NOT EXISTS public.kade_ai_usage (
  id UUID PRIMARY KEY DEFAULT gen_random_uuid(),
...
CREATE INDEX IF NOT EXISTS kade_ai_usage_created_idx ON public.kade_ai_usage (created_at);
