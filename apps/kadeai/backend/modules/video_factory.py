"""KadeAI Video Fabrikası — senaryodan otomatik video üretimi.

Vendored motor: MoneyPrinterTurbo (MIT, bkz. LICENSES/NOTICE.md), KadeAI
markası altında. Bu modül ince bir köprüdür:
  ...
  2. KadeAI ortam değişkenlerini (GEMINI/OPENAI/PEXELS...) motor konfigürasyonuna
...
def _bridge_env_to_config(config: Any, *, language: str) -> None:
    """KadeAI env değişkenlerini motorun `config.app` sözlüğüne aktarır."""
    app_cfg = config.app
