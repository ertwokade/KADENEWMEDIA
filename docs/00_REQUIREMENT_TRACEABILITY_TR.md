...
| REQ-ADMIN-001 | §10 Admin panelini 44 modüllü ürün yönetim merkezine dönüştürme | Kısmen tamamlandı | Faz 4 — mevcut admin ~30 fonksiyonel bölüm içeriyor (bkz. docs/01); bu turda roller/izinler modülü tamamlandı (aşağıya bkz.), kalan ~22 modül açık. **Feature flags modülü bilinçli olarak bu turda kurulmadı**: şu an hiçbir kod yolu koşullu bir flag'e bağlı değil, somut bir kullanım senaryosu olmadan bir flag sistemi kurmak şartnamenin kendi "gereksiz soyutlama ekleme" kuralına aykırı olur — ilk gerçek ihtiyaç (örn. kademeli bir özellik rollout'u) doğduğunda birlikte kurulmalı |
