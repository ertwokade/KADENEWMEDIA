...
export const HOME_HERO_DEFAULTS = {
  tr: {
    eyebrow: 'İSTANBUL · NEW MEDIA AJANSI',
    title1: 'Dijital dünyada',
    title2: 'markanı büyütüyoruz',
    subtitle: 'Strateji, içerik ve reklamı tek planda birleştirerek markaların düzenli ve ölçülebilir büyümesini sağlıyoruz.',
  ...
  en: {
    eyebrow: 'ISTANBUL · NEW MEDIA AGENCY',
    title1: 'We grow your brand',
    title2: 'in the digital world',
    subtitle: 'We combine strategy, content, and advertising in one plan to create consistent, measurable growth.',
