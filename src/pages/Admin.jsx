...
// Portfolyo listesi BOŞ başlar.
//
// Burada daha önce örnek olarak uydurma müşteri adları ("Flavora",
// "TechVibe", "GreenLife") ve doğrulanmamış performans rakamları
// ("2M+ erişim", "500K+ indirme", "%400 satış") sabit veri olarak
// duruyordu. Bu kayıtlar veritabanı boşken ekrana geliyor, yanlışlıkla
// kaydedilip yayına çıkabiliyor ve doğrulanmamış başarı iddiası
// oluşturuyordu. Gerçek projeler admin panelinden eklenir.
