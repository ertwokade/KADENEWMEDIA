...
export default function ProtectedAccessScreen({ eyebrow, eyebrowLang, title, description, customer, packageLabel = 'Paketleri İncele' }) {
    ...
    <PageTransition>
      <section className="kade-surface ok-access-page">
        <div className="ok-access-card">
          ...
          <span className="ok-eyebrow" lang={eyebrowLang}>{eyebrow}</span>
