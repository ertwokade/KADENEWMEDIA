...
/* Keep the clone's incomplete React/WebGL frame out of view. The neutral grid
   is already part of the real composition, so the hand-off does not introduce
   a separate loader, logo, text or animation. */
const CRITICAL_FIRST_PAINT = `<style data-kade-critical-first-paint>html:not([data-kade-loaded]) body::before{content:"";position:fixed;inset:0;z-index:2147483000;background-color:#fbfaf4;background-image:linear-gradient(rgba(54,54,48,.1) 1px,transparent 1px),linear-gradient(90deg,rgba(54,54,48,.1) 1px,transparent 1px);background-size:33.333vw 33.333vh;pointer-events:none}html.dark:not([data-kade-loaded]) body::before{background-color:#000;background-image:linear-gradient(rgba(251,250,244,.14) 1px,transparent 1px),linear-gradient(90deg,rgba(251,250,244,.14) 1px,transparent 1px)}html[data-kade-loaded] body::before{opacity:0;visibility:hidden;transition:opacity .14s ease,visibility 0s linear .14s}</style><link rel="preload" href="/model/hello.gltf" as="fetch" crossorigin><link rel="preload" href="/model/hello.bin" as="fetch" crossorigin><link rel="preload" href="/model/cnt.gltf" as="fetch" crossorigin><link rel="preload" href="/model/cnt.bin" as="fetch" crossorigin><link rel="preload" href="/model/cursor.glb" as="fetch" crossorigin>`
