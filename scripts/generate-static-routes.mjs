...
const routes = [
  ...
  ['/401', 'Yetkisiz erişim | Kade New Media', 'Bu sayfayı görüntülemek için giriş yapmanız gerekiyor.', true],
  ['/403', 'Erişim engellendi | Kade New Media', 'Bu sayfaya erişim yetkiniz bulunmuyor.', true],
  ['/429', 'Çok fazla istek | Kade New Media', 'Kısa sürede çok fazla istek gönderildi. Biraz bekleyip tekrar deneyin.', true],
  ['/bakim', 'Bakım çalışması | Kade New Media', 'Site kısa süreli bakımda. Birazdan tekrar deneyin.', true],
  ...
  ['/hakkimizda', 'Kade New Media Hakkında | New Media Ajansı İstanbul', 'Kade New Media; Kade New Media, Kademedia ve Kadenewmedia adlarıyla da aranan İstanbul merkezli new media ve dijital pazarlama ajansıdır.', false],
  ['/hizmetler', 'New Media ve Dijital Medya Hizmetleri | Kade New Media', 'Kade New Media’nın sosyal medya yönetimi, içerik üretimi, dijital reklam, video prodüksiyon, new media stratejisi ve web tasarımı hizmetleri.', false],
  ['/new-media-ajansi', 'New Media Ajansı İstanbul | Kade New Media', 'İstanbul merkezli Kade New Media ile new media stratejisi, sosyal medya yönetimi, içerik üretimi, dijital reklam, video prodüksiyon ve web tasarımı.', false],
  ['/iletisim', 'Kade New Media İletişim | Projenizi Paylaşın', 'Sosyal medya, dijital pazarlama, içerik üretimi veya web projeniz için Kade New Media ile iletişime geçin ve ihtiyacınızı paylaşın.', false],
  ['/paketler', 'Paketler | Kade New Media', 'Düzenli içerik, reklam yönetimi ve proje bazlı prodüksiyon ihtiyaçlarına göre şekillenen Kade New Media hizmet kapsamlarını inceleyin.', false],
  ['/sss', 'Dijital Pazarlama Sık Sorulan Sorular | Kade New Media', 'Kade New Media’nın hizmetleri, teklif süreci, çalışma biçimi, teslimat ve iletişim adımları hakkında sık sorulan soruların yanıtlarını inceleyin.', false],
  ['/ekip', 'Kade New Media Ekibi | İstanbul Dijital Pazarlama Ajansı', 'Kade New Media’nın sosyal medya, içerik üretimi, reklam ve dijital projelerde birlikte çalışan İstanbul merkezli ekibiyle tanışın.', false],
  ['/kariyer', 'Kade New Media Kariyer | Genel Başvuru Bilgileri', 'Kade New Media’daki kariyer olanakları ve genel başvuru süreci hakkında bilgi alın; uzmanlık alanınızı ve çalışmalarınızı bizimle paylaşın.', false],
  ['/tesekkur', 'Talep Durumu | Kade New Media', 'İletişim talebinizin durumunu form üzerinden doğrulayın.', true],
  ['/portfolio', 'Portfolyo | Kade New Media', 'Onaylı proje detayları müşteri izniyle yayınlanır.', true],
  ['/fiyat-hesaplama', 'Fiyat Hesaplama | Kade New Media', 'Hizmet kapsamına göre yaklaşık aylık bütçe hesaplama aracı.', true],
  ['/basin', 'Basın Odası | Kade New Media', 'Kade New Media şirket bilgileri, marka materyalleri ve basın iletişimi.', false],
  ['/neden-biz', 'Neden Kade New Media?', 'Kade New Media çalışma modeli, süreçleri ve ölçülebilir farkları.', false],
  ['/referans-programi', 'Referans Programı | Kade New Media', 'Kade New Media referans programı ve işleyişi.', true],
  ['/podcast-webinar', 'Podcast & Webinar | Kade New Media', 'Yeni medya, içerik ve reklam üzerine Kade New Media yayınları.', false],
  ['/bulten-arsivi', 'Bülten Arşivi | Kade New Media', 'Kade New Media bültenleri ve dijital pazarlama notları.', false],
  ['/partnerler', 'İş Ortakları | Kade New Media', 'Doğrulanmış Kade New Media iş ortaklığı bilgileri.', true],
  ['/blog', 'İçgörüler | Kade New Media', 'Kaynağı kontrol edilmiş Kade New Media yazıları.', false],
  ['/teklif-al', 'Dijital Pazarlama Teklifi Al | Kade New Media', 'İhtiyacınız olan sosyal medya, içerik, reklam, video veya web hizmetlerini seçin; projeniz için Kade New Media’dan yazılı teklif isteyin.', false],
  ['/referanslar', 'Müşteri Referansları | Kade New Media', 'Doğrulanmış müşteri referansları.', true],
  ['/basari-hikayeleri', 'Vaka Çalışmaları | Kade New Media', 'Doğrulanmış vaka çalışmaları.', false],
  ['/kvkk', 'KVKK Aydınlatma Metni | Kade New Media', 'Kade New Media’nın kişisel verileri hangi amaçlarla ve hukuki sebeplerle işlediğini açıklayan KVKK aydınlatma metnini inceleyin.', false],
  ['/gizlilik', 'Gizlilik Politikası | Kade New Media', 'Kade New Media web sitesinde kişisel verilerin nasıl toplandığı, kullanıldığı, korunduğu ve hangi haklara sahip olduğunuz hakkında bilgi alın.', false],
  ['/cerez-politikasi', 'Çerez Politikası | Kade New Media', 'Kade New Media web sitesinde kullanılan çerez türlerini, kullanım amaçlarını ve çerez tercihlerinizi nasıl yönetebileceğinizi öğrenin.', false],
  ['/telif-haklari', 'Telif Hakları | Kade New Media', 'Kade New Media web sitesindeki içerik, görsel, video ve tasarımların telif hakları, kullanım koşulları ve izin süreçleri hakkında bilgi alın.', false],
  ['/giris', 'Çalışma Alanı Seçimi | Kade New Media', 'Danışmanlık ve Content AI çalışma alanlarından kullanmak istediğinizi seçin.', true],
  ['/giris/danismanlik', 'Danışmanlık Girişi | Kade New Media', 'Kade New Media danışmanlık ve müşteri hesabı giriş sayfası.', true],
  ['/musteri-panel', 'Müşteri Paneli | Kade New Media', 'Korumalı müşteri alanı.', true],
  ['/admin', 'Yönetim Paneli | Kade New Media', 'Korumalı yönetim alanı.', true],
  ['/organizasyon-kiti', 'Kade Organizasyon Kiti', 'Korumalı müşteri çalışma alanı.', true],
  ['/organizasyon-kiti/plan/fractional-new-media-director', 'Danışmanlık Planı | Kade New Media', 'Korumalı müşteri çalışma alanı.', true],
  ['/organizasyon-kiti/medya-yol-haritasi', 'Medya Yol Haritası | Kade New Media', 'Korumalı müşteri çalışma alanı.', true],
  ['/organizasyon-kiti/yonetim-toplantilari', 'Yönetim Toplantıları | Kade New Media', 'Korumalı müşteri çalışma alanı.', true],
  ['/organizasyon-kiti/ekip-surecler', 'Ekip ve Süreçler | Kade New Media', 'Korumalı müşteri çalışma alanı.', true],
  ['/organizasyon-kiti/stratejik-kararlar', 'Stratejik Kararlar | Kade New Media', 'Korumalı müşteri çalışma alanı.', true],
  ['/organizasyon-kiti/notlar', 'Danışmanlık Notları | Kade New Media', 'Korumalı müşteri çalışma alanı.', true],
  ['/kade-kit-business', 'Kade Kit Business | Kade New Media', 'Korumalı müşteri çalışma alanı.', true],
  ['/proje-takip', 'Proje Takip | Kade New Media', 'Korumalı müşteri çalışma alanı.', true],
  ['/hizmetler/sosyal-medya-yonetimi', 'Sosyal Medya Yönetimi | Kade New Media', 'Instagram, Facebook, TikTok ve LinkedIn için içerik planlama, yayın takvimi, topluluk yönetimi, raporlama ve marka iletişimi hizmetleri.', false],
  ['/hizmetler/icerik-uretimi', 'İçerik Üretimi | Kade New Media', 'Markanıza özel görsel, video ve metin içerikleri; içerik stratejisi, grafik tasarım, metin yazımı, fotoğraf çekimi ve sosyal medya tasarımları.', false],
  ['/hizmetler/reklam-yonetimi', 'Dijital Reklam Yönetimi | Kade New Media', 'Meta, Google Ads ve TikTok Ads kampanyaları için planlama, hedefleme, A/B testleri, yeniden pazarlama ve performans analizi hizmetleri.', false],
  ['/hizmetler/video-produksiyon', 'Video Prodüksiyon | Kade New Media', 'Reels, TikTok, YouTube ve reklam projeleri için senaryo, çekim, kurgu, motion graphics ve proje kapsamına göre prodüksiyon hizmetleri.', false],
  ['/hizmetler/strateji-danismanlik', 'Dijital Strateji ve Danışmanlık | Kade New Media', 'Marka ve rakip analizi, hedef ve KPI belirleme, dijital pazarlama yol haritası, büyüme planı ve strateji danışmanlığı hizmetleri.', false],
  ['/hizmetler/web-sitesi-tasarimi', 'Web Sitesi Tasarımı ve Geliştirme | Kade New Media', 'Markanıza özel mobil uyumlu web sitesi tasarımı, UI/UX, geliştirme, CMS ve e-ticaret entegrasyonu ile performans iyileştirme hizmetleri.', false],
]
...
function extraContent(route) {
  ...
  if (route === '/new-media-ajansi') {
    return `
      ...
      <p>New media; sosyal ağları, arama motorlarını, dijital reklamı, içerik formatlarını, videoyu ve web deneyimini birlikte kapsar. Kade New Media bu alanları marka görünürlüğü, talep toplama ve sürdürülebilir iletişim hedefleri için ortak bir plan içinde yönetir.</p>
      <h2>Hizmetler</h2>
      ${NMA_SERVICES.map((s) => `<h3><a href="${s.to}">${escapeHtml(s.title)}</a></h3>\n      <p>${escapeHtml(s.description)}</p>`).join('\n      ')}
...
function structuredData(route, title, description, noindex) {
  ...
  if (hasServiceSchema) {
    schemas.push({
      ...
      description,
      url: `${BASE}${route}`,
      provider: { '@type': 'Organization', name: 'Kade New Media', url: `${BASE}/` },
