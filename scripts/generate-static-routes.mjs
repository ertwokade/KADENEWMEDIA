...
const routes = [
  ...
  ['/tesekkur', 'Talep Durumu | Kade Media', 'İletişim talebinizin durumunu form üzerinden doğrulayın.', true],
  ...
  ['/blog', 'İçgörüler | Kade Media', 'Kaynağı kontrol edilmiş Kade Media yazıları.', false],
  ...
  ['/basari-hikayeleri', 'Vaka Çalışmaları | Kade Media', 'Doğrulanmış vaka çalışmaları.', false],
